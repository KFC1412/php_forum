...
$auth_users = array(
    'admin' => '$2y$10$WP6bYRuxol9h/v8LEKKnoOHj5K.1TzKpubuBL6Eq13Wmz5qjqB5sC' //123456
);
                ...
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://kfc1412.github.io/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">2026 综合社区</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mb-2" data-bs-theme="<?php echo FM_THEME; ?>">
            ...
            <div class="card-body">
                <form id="js-settings-form" action="" method="post" data-type="ajax" onsubmit="return save_settings(this)">
                    ...
                    <small class="text-body-secondary">* <?php echo lng('有时保存任务也许第一次不成功，所以请再试一次') ?>。</span>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/kfc1412/ target="_blank" class="app-v-title"> EDUCN File Manager <?php echo VERSION; ?></a></h3>
                        </p>
                        <p>Author: EDUCN</p>
                        <p>Mail Us: <a href="mailto:by2312@qq.com">by2312 [at] qq [dot] com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
?>
    ...
    <head>
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "EDUCN")); ?></title>
        <?php print_external('pre-jsdelivr'); ?>
